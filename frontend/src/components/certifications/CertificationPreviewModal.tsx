      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-3.5 border-b border-[#d0d7de] dark:border-[#30363d] bg-white dark:bg-[#161b22] shrink-0">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-[#d97706]/10 text-[#d97706] dark:text-[#f59e0b] border border-[#d97706]/20 flex items-center justify-center">
              <Award className="w-4 h-4" />
            </div>
            <div>
              <div className="flex items-center gap-2">
                <span id="preview-modal-title" className="text-sm font-bold text-[#24292f] dark:text-[#f0f6fc]">
        ...
        <div className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-6">
          <CertificationDetailView cert={cert} isDraftPreview={true} />
        </div>
