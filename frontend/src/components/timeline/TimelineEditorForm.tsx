...
export function TimelineEditorForm({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="sticky top-0 z-20 bg-[#f6f8fa]/95 dark:bg-[#0d1117]/95 backdrop-blur-xs py-3 border-b border-[#d0d7de] dark:border-[#30363d] flex items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-base font-bold text-[#24292f] dark:text-white tracking-tight flex items-center gap-2">
              <span>{isNew ? "New Manual Milestone" : formData.title || "Edit Manual Milestone"}</span>
              {isDirty && (
            ...
            <p className="text-[11px] font-mono text-[#57606a] dark:text-[#8b949e]">
              Manual Milestone Record &bull; PostgreSQL 16
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white dark:bg-[#21262d] hover:bg-[#f6f8fa] dark:hover:bg-[#30363d] border border-[#d0d7de] dark:border-[#30363d] text-xs font-semibold text-[#24292f] dark:text-[#f0f6fc] transition-all cursor-pointer"
          >
          ...
          <button
            ...
            disabled={isSaving}
            className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-lg bg-[#0969da] hover:bg-[#0859b8] text-xs font-semibold text-white transition-all cursor-pointer shadow-xs disabled:opacity-50"
          >
            <Save className="w-3.5 h-3.5" />
            <span>{isSaving ? "Saving..." : isNew ? "Create Milestone" : "Save Changes"}</span>
          </button>
        </div>
      </div>
      ...
      {/* Helper Callout */}
      <div className="p-4 rounded-xl bg-blue-500/10 border border-blue-500/20 text-xs text-blue-900 dark:text-blue-300 flex items-start gap-3">
        <Milestone className="w-4 h-4 text-blue-600 dark:text-blue-400 mt-0.5 shrink-0" />
        <div className="space-y-1">
          <p className="font-semibold text-blue-950 dark:text-blue-200">
            Manual Milestone Control Plane
          </p>
          <p className="text-blue-800 dark:text-blue-300/90 leading-relaxed">
            Use this editor for standalone career milestones, awards, speaking engagements, relocations, or launches.
            Work Experiences, Degrees, and Certifications automatically project to the Timeline from their canonical workspaces.
          </p>
        </div>
      </div>
