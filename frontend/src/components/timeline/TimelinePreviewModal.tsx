...
import { X, Sparkles, Milestone } from "lucide-react";
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 md:p-6 bg-black/60 backdrop-blur-xs animate-in fade-in duration-150">
      ...
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span id="timeline-preview-title" className="text-sm font-bold text-[#24292f] dark:text-[#f0f6fc]">
              ...
              <p className="text-xs font-mono text-[#57606a] dark:text-[#8b949e]">
                {timelineItem.title} &bull; {timelineItem.date}
              </p>
            </div>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-6">
          <CareerTimelineView
            timeline={previewItems}
            isDraftPreview={true}
            activeItemSlug={timelineItem.slug}
          />
        </div>
